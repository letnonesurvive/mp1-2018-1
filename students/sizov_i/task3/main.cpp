...
public:
	...
	void NewMenu()
	{
		...
		if (trigger == true)
		{
			cout << "ѕоследний пункт меню: " << getnum();
		}
		cout << endl;
		for (int i = 0; i <= x; i++)
		{
...
void main()
{
	...
	menu2.SetCommands(1, "ѕункт первый");//демонстраци€ внутри кода
	menu2.SetCommands(2, "ѕункт второй");
	menu2.SetCommands(3, "ѕункт третий");
	menu2.Print();
}